 ...
 * Fix small issue with our internal messaging system
 * Add the table shortcode button to WP editor
 * Fix of displaying the table editor and table options in admin area
 * Fix of insert link to table cell
 * Added Table History functionality
 * Small styles fix
 * Fix of table rename
 * Added Time format
 * Fix PDF export for backend and frontend
 * Small code fix
