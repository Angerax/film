...
(function ($, app, undefined) {
	$(document).ready(function () {
		...
		editor.addHook('afterCreateRow', function (changes, source) {
			updateUndoRedoBtns();
		});
		editor.addHook('afterCreateCol', function (changes, source) {
			updateUndoRedoBtns();
		});
		editor.addHook('afterRemoveRow', function (changes, source) {
			updateUndoRedoBtns();
		});
		editor.addHook('afterRemoveCol', function (changes, source) {
			updateUndoRedoBtns();
		});
